...
for i in $(seq 1 $TEST_TIMES); do
	...
	/.wasmedge-ggml/bin/wasmedge --dir .:. --env enable_log=true --nn-preload default:GGML:AUTO:llama-2-7b-chat.Q4_0.gguf /wasmedge-ggml-llama.wasm default "Once upon a time, there existed a little girl," > /output/ggml-wasi-$timestamp.log 2>&1
